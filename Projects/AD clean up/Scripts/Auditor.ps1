...
$OUpath = 'OU=redacted,OU=redacted,DC=aus,DC=redacted,DC=com,DC=au'
$ou = 'OU=redacted,DC=aus,DC=redacted,DC=com,DC=au'

#export path for reports
$EPEndaated = '\\aus.redacted.com.au\redacted\redacted\users\e103719\Documents\Reports\end-dated-users-not-disabled.csv'
$EPDisabled = '\\aus.redacted.com.au\redacted\redacted\users\e103719\Documents\Reports\disabled-not-end-dated.csv'
$E5Disabled ='\\aus.redacted.com.au\redacted\redacted\users\e103719\Documents\Reports\E5AssignedDisabled.csv'
$E3Disabled ='\\aus.redacted.com.au\redacted\redacted\users\e103719\Documents\Reports\E3AssignedDisabled.csv'
$E3callingDisabled ='\\aus.redacted.com.au\redacted\homedir\users\e103719\Documents\Reports\E3callingAssignedDisabled.csv'
$F3Disabled ='\\aus.redacted.com.au\redacted\redacted\users\e103719\Documents\Reports\f3Disabled.csv'
$gal ='\\aus.redacted.com.au\redacted\redacted\users\e103719\Documents\Reports\Gal.csv'
$ghost ='\\aus.redacted.com.au\redacted\redacted\users\e103719\Documents\Reports\ghosts.csv'
$endDatedUsersWithDlgroups = "\\aus.redacted.com.au\redacted\redacted\users\e103719\Documents\Reports\end-dated-users-with-Dl-groups.csv"

#pre run clean up

Remove-Item $EPEndaated;
Remove-Item $EPDisabled;
Remove-Item $E5Disabled;
Remove-Item $E3Disabled;
Remove-Item $E3callingDisabled;
Remove-Item $F3Disabled;
Remove-Item $gal;
Remove-Item $ghost;
Remove-Item $endDatedUsersWithDlgroups;
